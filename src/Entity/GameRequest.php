...
class GameRequest {
	...
	private ?House $from_house;
	private ?Place $from_place;
	private ?RealmPosition $from_position;
	private ?Association $from_association;
	private ?Character $to_character;
	private ?Settlement $to_settlement;
	private ?Realm $to_realm;
	private ?House $to_house;
	private ?Place $to_place;
	private ?RealmPosition $to_position;
	private ?Association $to_association;
	private ?Character $include_character;
	private ?Settlement $include_settlement;
	private ?Realm $include_realm;
	private ?House $include_house;
	private ?Place $include_place;
	private ?RealmPosition $include_position;
	private ?Association $include_association;
