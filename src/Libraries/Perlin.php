...
class Perlin {
	...
	function smoothNoise($x, $y, $z): float|int {
		...
		return $this->lerp(
			...
			$this->lerp(
				$v,
				$this->lerp($u, $this->grad($this->p[$AA+1], $x  , $y  , $z-1 ),  // CORNERS
	...
	function random1D($x,$size=null): float|int {
   ...
   function random2D($x,$y,$size=null): float|int {
