...
class RealmManager {
	...
	public function subcreate($name, $formalname, $type, Character $ruler, Character $founder, Realm $parentrealm): Realm {
	...
	public function abandon(Realm $realm): void {
	...
	public function makeRuler(Realm $realm, Character $newruler, $ignore_position=false): void {
	...
	public function removeRulerLiege(Realm $realm, Character $newruler): void {
	...
	public function countElection(Election $election): void {
	...
	public function dropIncumbents(Election $election): void {
	...
	public function dismantleRealm(Character $character, Realm $realm, $sovereign=false): void {
		$this->history->logEvent(
			$realm,
