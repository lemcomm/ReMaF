...
#					break;
	...
	private function getLink($name): string {
		return match (strtolower($name)) {
			...
			'feature', 'featuretype' => 'maf_info_feature',
			'building', 'buildingtype' => 'maf_info_building',
			'entourage', 'entouragetype' => 'maf_info_entourage',
			'equipmenttype' => 'maf_info_equipment',
	...
	public function ObjectLink($entity, $raw=false, $absolute=false, $number=1, $extra=null): string {
		if (!is_object($entity)) {
			...
			$this->logger->error("dump: ".dump($entity));
