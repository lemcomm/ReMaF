...
use App\Entity\PlaceSubType;
use App\Entity\PlaceUpgradeType;

class LoadPlaceData extends Fixture {

	private array $placetypes = array(
		'academy'	=> array('requires' => 'academy',	'visible' => false,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'arena'		=> array('requires' => 'arena',		'visible' => true,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'blacksmith'	=> array('requires' => 'smith',		'visible' => true,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>true,	'vassals'=>true,	'pop' => 0),
		'bridge'	=> array('requires' => '',		'visible' => false,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>false,	'pop' => 0),
		...
		'cave'		=> array('requires' => 'outside',	'visible' => true,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>false,	'pop' => 0),
		'collective'	=> array('requires' => '',		'visible' => true,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		...
		'farm'		=> array('requires' => 'outside',	'visible' => true,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'fort'		=> array('requires' => 'outside',	'visible' => true,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'guild house'	=> array('requires' => 'guilds',	'visible' => true,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'hall'		=> array('requires' => '',		'visible' => true,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'home'		=> array('requires' => '',		'visible' => true,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>true,	'vassals'=>true,	'pop' => 0),
		'inn'		=> array('requires' => 'inn',		'visible' => true,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'intersection'	=> array('requires' => '',		'visible' => true,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>false,	'pop' => 0),
		'library'	=> array('requires' => '',		'visible' => true,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'list field'	=> array('requires' => 'list field',	'visible' => true,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'lumber yard'	=> array('requires' => 'forested',	'visible' => true,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'mine'		=> array('requires' => 'metals',	'visible' => true,	'defensible'=>false,	'public'=>true,	 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		...
		'temple'	=> array('requires' => 'temple',	'visible' => true,	'defensible'=>true,	'public'=>false, 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
		'track'		=> array('requires' => 'track',		'visible' => true,	'defensible'=>false,	'public'=>false, 'assocs'=>true,	'spawnable'=>false,	'vassals'=>true,	'pop' => 0),
	...
	private array $placeupgradetypes = array(
	...
	public function load(ObjectManager $manager): void {
		...
		foreach ($this->placesubtypes as $name=>$data) {
			$type = $manager->getRepository(PlaceSubType::class)->findOneBy(['name'=>$name]);
			if (!$type) {
				$type = new PlaceSubType();
				$manager->persist($type);
			}
			$type->setName($name);
			$type->setPlaceType($manager->getRepository(PlaceType::class)->findOneBy(['name'=>$data['type']]));
			$manager->persist($type);
		}
		# Load Place upgrades.
		foreach ($this->placeupgradetypes as $name=>$data) {
			$type = $manager->getRepository(PlaceUpgradeType::class)->findOneBy(['name'=>$name]);
			if (!$type) {
